...
//  SwiftSample
//
//  Created by Windy on 2016/12/26.
...
extension NetworkRequest {
    ...
    func test() {
        ...
        Alamofire.request(urlString, method: HTTPMethod.post, parameters: params, encoding: JSONEncoding.default, headers: requestHeader).responseJSON{(response) in
}
    }
